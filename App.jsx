...
/* ---------- example "photos" (self-contained SVG scenes) ---------- */
const svgPhoto = (svg) => `data:image/svg+xml,${encodeURIComponent(svg.replace(/\s+/g, " ").trim())}`;
const PHOTOS = {
  traffic: svgPhoto(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 240'>
    <defs><linearGradient id='s' x1='0' y1='0' x2='0' y2='1'><stop offset='0' stop-color='#FDB863'/><stop offset='.6' stop-color='#F98B60'/><stop offset='1' stop-color='#7A5AA0'/></linearGradient></defs>
    <rect width='400' height='240' fill='url(#s)'/><circle cx='200' cy='150' r='34' fill='#FFE9B0' opacity='.9'/>
    <rect y='150' width='400' height='90' fill='#3A3550'/><polygon points='150,150 250,150 340,240 60,240' fill='#4A4560'/>
    <g fill='#FFD54A'><rect x='196' y='160' width='8' height='16'/><rect x='194' y='186' width='12' height='20'/><rect x='191' y='214' width='18' height='26'/></g>
    <g fill='#FF5A4D'><rect x='120' y='176' width='26' height='14' rx='3'/><rect x='250' y='176' width='26' height='14' rx='3'/><rect x='95' y='200' width='34' height='18' rx='3'/><rect x='270' y='200' width='34' height='18' rx='3'/></g></svg>`),
  market: svgPhoto(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 240'>
    <rect width='400' height='240' fill='#F3E2C7'/><rect x='0' y='40' width='400' height='30' fill='#C0392B'/>
    <g fill='#fff' opacity='.5'><rect x='0' y='40' width='40' height='30'/><rect x='80' y='40' width='40' height='30'/><rect x='160' y='40' width='40' height='30'/><rect x='240' y='40' width='40' height='30'/><rect x='320' y='40' width='40' height='30'/></g>
    <rect x='20' y='118' width='110' height='60' fill='#E67E22'/><rect x='150' y='118' width='110' height='60' fill='#27AE60'/><rect x='280' y='118' width='100' height='60' fill='#D35400'/>
    <g fill='#6B4A2B'><circle cx='60' cy='200' r='14'/><circle cx='110' cy='210' r='14'/><circle cx='170' cy='205' r='14'/><circle cx='220' cy='212' r='14'/><circle cx='280' cy='204' r='14'/><circle cx='330' cy='210' r='14'/></g>
    <rect y='224' width='400' height='16' fill='#8C6239'/></svg>`),
  rain: svgPhoto(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 240'>
    <rect width='400' height='240' fill='#6B7B8C'/><path d='M0 170 Q100 120 200 160 T400 150 V240 H0 Z' fill='#3E5C4B'/>
    <path d='M0 190 Q120 150 240 185 T400 180 V240 H0 Z' fill='#2E4A3A'/>
    <g stroke='#CBD5E1' stroke-width='2' opacity='.7'><line x1='40' y1='10' x2='30' y2='40'/><line x1='90' y1='20' x2='80' y2='50'/><line x1='150' y1='5' x2='140' y2='35'/><line x1='210' y1='25' x2='200' y2='55'/><line x1='270' y1='10' x2='260' y2='40'/><line x1='330' y1='20' x2='320' y2='50'/><line x1='370' y1='8' x2='360' y2='38'/><line x1='120' y1='60' x2='110' y2='90'/><line x1='240' y1='70' x2='230' y2='100'/><line x1='300' y1='55' x2='290' y2='85'/></g></svg>`),
  concert: svgPhoto(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 240'>
    <rect width='400' height='240' fill='#140B2E'/><ellipse cx='200' cy='200' rx='180' ry='60' fill='#3A1D6E' opacity='.8'/>
    <g opacity='.55'><polygon points='120,0 90,220 150,220' fill='#FF4D8D'/><polygon points='200,0 180,220 240,220' fill='#4DE1FF'/><polygon points='280,0 260,220 320,220' fill='#B14DFF'/></g>
    <rect x='150' y='120' width='100' height='60' fill='#000' opacity='.85'/>
    <g fill='#000' opacity='.85'><circle cx='40' cy='232' r='16'/><circle cx='90' cy='234' r='16'/><circle cx='140' cy='230' r='16'/><circle cx='200' cy='234' r='16'/><circle cx='260' cy='230' r='16'/><circle cx='310' cy='234' r='16'/><circle cx='360' cy='232' r='16'/></g></svg>`),
  cafe: svgPhoto(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 240'>
    <rect width='400' height='240' fill='#E9DFCE'/><rect y='150' width='400' height='90' fill='#6F4E37'/>
    <rect x='40' y='40' width='320' height='110' rx='6' fill='#B7D7D0'/>
    <text x='200' y='108' font-family='sans-serif' font-size='34' font-weight='700' fill='#3A2A1A' text-anchor='middle'>CAFE</text>
    <rect x='170' y='180' width='60' height='40' rx='6' fill='#EFE7DA'/><path d='M230 188 q18 4 0 24' stroke='#EFE7DA' stroke-width='6' fill='none'/>
    <g stroke='#fff' stroke-width='3' opacity='.6' fill='none'><path d='M188 172 q6 -8 0 -16'/><path d='M212 172 q6 -8 0 -16'/></g></svg>`),
};
...
function seedData() {
  ...
  const statuses = [
    ...
    { id: uid(), userId: "u_dan", category: "road", text: "בור גדול בכביש 4 סמוך לצומת מסובים, סעו בזהירות בנתיב הימני.", locationName: "כביש 4, מסובים", lat: 32.05, lng: 34.88, createdAt: t - 95 * MIN, expiresAt: t + 5 * HR, likes: [], comments: [], img: null },
    ...
    { id: uid(), userId: "u_avi", category: "security", text: "פעילות משטרתית מוגברת ליד התחנה המרכזית, עדיף לעקוף.", locationName: "מרכזית מפרץ, חיפה", lat: 32.79, lng: 35.06, createdAt: t - 4 * HR, expiresAt: t - 10 * MIN /* expired */, likes: ["u_me"], comments: [], img: null },
  ];
